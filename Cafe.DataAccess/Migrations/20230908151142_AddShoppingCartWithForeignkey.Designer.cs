...
namespace Cafe.DataAccess.Migrations
{
    ...
    [Migration("20230908151142_AddShoppingCartWithForeignkey")]
    partial class AddShoppingCartWithForeignkey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cafe.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cafe.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cafe.Models.ShoppingCart", b =>
                {
                    b.HasOne("Cafe.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Cafe.Models.ApplicationUser", b =>
                {
                    b.HasOne("Cafe.Models.Company", "Company")
                        .WithMany()
